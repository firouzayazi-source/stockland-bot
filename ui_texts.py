...
DEFAULT_UI_TEXTS = {
    ...
    "MSG_WELCOME":
        ...
        "🛍 محصولات ما تحویل آنی دارند\n"
        "💰 می‌توانید با کیف پول خرید کنید\n"
    ...
    "SUPPORT_TEXT":
        "👨‍💻 <b>پشتیبانی</b>\n\n"
        "سوال، مشکل یا پیشنهادی دارید؟\n"
        "پیام خود را ارسال کنید — تیم پشتیبانی ما در کوتاه‌ترین زمان پاسخ می‌دهد.\n\n"
        "⏰ ساعات پاسخ‌گویی: شنبه تا پنجشنبه، ۹ صبح تا ۹ شب",
    "HELP_TEXT":
        "📖 <b>راهنمای استفاده از فروشگاه</b>\n\n"
        "🛍 <b>خرید محصول:</b>\n"
        "از منوی اصلی دسته‌بندی مورد نظر را انتخاب کنید، محصول را بخرید "
        "و اطلاعات آن فوری تحویل داده می‌شود.\n\n"
        "💰 <b>کیف پول:</b>\n"
        "برای شارژ، از طریق کارت‌به‌کارت یا درگاه آنلاین اقدام کنید. "
        "خریدهای بعدی با موجودی کیف پول سریع‌تر انجام می‌شوند.\n\n"
        "🧾 <b>سفارش‌های من:</b>\n"
        "تمام خریدهای قبلی و اطلاعات آن‌ها اینجا قابل مشاهده است.\n\n"
        "🤝 <b>همکاری در فروش:</b>\n"
        "با معرفی دوستان و همکاری در فروش درآمد کسب کنید. "
        "گزینه «درخواست نمایندگی» را انتخاب کنید.\n\n"
        "👨‍💻 <b>پشتیبانی:</b>\n"
        "هر سوال یا مشکلی داشتید، از طریق بخش پشتیبانی با ما در تماس باشید.",
    ...
    "PARTNER_GUIDE_TEXT":
        ...
        "از هر خریدی که آن‌ها انجام می‌دهند، پورسانت دریافت می‌کنید.\n\n"
        "💰 <b>پورسانت فروش:</b>\n"
        "پورسانت بر اساس سطح فعالیت شما محاسبه می‌شود. "
        "هر چه بیشتر بفروشید، به سطح بالاتری با درآمد بیشتر می‌رسید.\n\n"
        "🏆 <b>سطوح همکاری:</b>\n"
        "با افزایش فروش به سطوح بالاتر ارتقا می‌یابید و "
        "پورسانت بیشتری دریافت می‌کنید.\n\n"
        "📤 <b>درخواست تسویه:</b>\n"
        "پس از رسیدن موجودی کیف‌پول همکاری به حداقل مبلغ، "
        "می‌توانید درخواست تسویه به حساب بانکی ثبت‌شده ارسال کنید.\n\n"
        "⚠️ <b>قوانین مهم:</b>\n"
        "• تبلیغات غیراخلاقی یا گمراه‌کننده ممنوع است\n"
        "• هرگونه تقلب موجب تعلیق همکاری می‌شود\n"
        "• درآمدها صرفاً از خریدهای واقعی محاسبه می‌شود\n\n"
