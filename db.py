...
PROMO_DEFAULTS  = {"text": (
    "🎁 {name} شما را به استوک‌لند دعوت کرد!\n"
    "فروشگاه دیجیتال با تحویل آنی، پشتیبانی ۲۴ ساعته و قیمت‌های واقعاً رقابتی.\n\n"
    "همین الان عضو شو و از هدیهٔ خوش‌آمدگویی بهره‌مند شو 🎉"
)}
