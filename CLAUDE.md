...
> تاریخ آخرین بروزرسانی افزایشی: ۲۰۲۶-۰۷-۲۶ — بعد از چند راند توسعهٔ مینی‌اپ (بخش ۲۱) + افزودن فیچر مستقل «کارشناس هوشمند قیمت آیفون» (بخش ۲۲، شامل نرمال‌سازی کامل دیتابیس قیمت‌گذاری و بازطراحی پنل به لیست تخت قیمت‌ها) — قبل از کار روی هرکدوم، همون بخش رو بخون تا نیازی به خوندن دوبارهٔ کد نباشه.
