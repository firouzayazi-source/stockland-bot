...
⚠️ **در حال بررسی، هنوز اقدامی نشده (۲۰۲۶-۰۸-۰۲، دور بعد):** مالک پروژه هدف بزرگ‌تری برای این بخش مطرح کرد — می‌خواد کل خروجی کارشناسی حس یک «منبع استعلام قیمت آیفون» هیجان‌انگیز بده، نه چیزی که کاربر حس کنه طراحی شده تا گوشیش رو ارزون بخره. این صرفاً یه لیبل نیست، بازطراحی لحن/چیدمان کل پیام نتیجه‌ست — قبل از هر تغییری، نظر کارشناسی از این دستیار خواسته شده و هنوز منتظر تأیید مالک پروژه برای پیاده‌سازیه.
