...
> تاریخ آخرین بروزرسانی افزایشی: ۲۰۲۶-۰۸-۰۱ — رفع ۳ باگ محاسباتی حسابداری + ادغام گزارش مالی + چپ‌چین اعداد پنل، رفع باگ سراسری دکمهٔ نامرئی (متغیر CSS `--clr-primary`)، بازطراحی صفحهٔ خلاصهٔ ویزارد کارشناسی آیفون، و تکمیل حسابداری با Import عمومی TXT/CSV/Excel + «تعویض کالا» + گزارش‌گیری (بخش ۲۹) — قبل از کار روی هرکدوم، همون بخش رو بخون تا نیازی به خوندن دوبارهٔ کد نباشه.
