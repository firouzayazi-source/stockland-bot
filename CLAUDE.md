...
> تاریخ آخرین بروزرسانی افزایشی: ۲۰۲۶-۰۸-۰۲ — رفع ۳ باگ محاسباتی حسابداری + ادغام گزارش مالی + چپ‌چین اعداد پنل، رفع باگ سراسری دکمهٔ نامرئی (متغیر CSS `--clr-primary`)، بازطراحی صفحهٔ خلاصهٔ ویزارد کارشناسی آیفون، تکمیل حسابداری با Import عمومی TXT/CSV/Excel + «تعویض کالا» + گزارش‌گیری، رفع نوتیف درخواست فروش + راست‌چین/چپ‌چین ستاره‌ها-نمودارها + کیف‌پول پاداش مینی‌اپ، بازطراحی Premium صفحهٔ «دعوت دوستان» مینی‌اپ، و رفع کامل متن/اشتراک‌گذاری دعوت — تگ HTML خام، تکرار لینک، و برگشت نهایی به الگوی استاندارد `url=+text=` تلگرام (بخش ۲۹، ۳۰ و ۳۱) — قبل از کار روی هرکدوم، همون بخش رو بخون تا نیازی به خوندن دوبارهٔ کد نباشه.
