...
def _default_payment_base_url() -> str:
    ...
    Because the bot and the payment service run in ONE process, calling
    localhost on the same port that uvicorn bound to always works -- no need
    to hand-set any variable on Railway.
    """
